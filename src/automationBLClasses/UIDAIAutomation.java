...
public class UIDAIAutomation {
	...
	private static WebDriver newBrowser; // Instance Variable/class variable...
	...
	public static String searchWorkflowAutomation() {
		...
		// Creating Browser Instances for latest versions of Browsers..
		...
		// Step 2 : Launching the Browser Instance & Loading the Web Application
		// onto the Browser instance...
		...
		newBrowser.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); // Implicit
																				// waiting...
	...
	public static void mouseKeyBoardWorkflowAutomation() throws IOException {
		...
		Action mouseEvents = mouseActions.moveToElement(resourceLinkText).click().moveToElement(authenticationLinkText)
				.click().moveToElement(biometricLinkText).click().build();
	...
	public static void searchWorkflowAutomationUsingAUIAPI() throws IOException {
		...
		// Advance User Interactions API...
		Actions mouseActions = new Actions(newBrowser);
		Action mouseEvents = mouseActions.moveToElement(searchIcon).click().sendKeys(searchTextBox, "Aadhar Centres")
